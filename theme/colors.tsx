...
export const colorThemes: {[key: string]: ITheme} = {
  ...
  [EColorTheme.DARK_PURPLE]: {
    ...sharedColors,
    negModifier: 'hsla(0, 40%, 55%, 1)',
    posModifier: 'hsla(130, 27%, 57%, 1)',
    darker: 'hsla(250, 59%, 92%, 1)',
    dark: 'hsla(250, 59%, 60%, 1)',
    mediumDark: 'hsla(250, 59%, 42%, 1)',
    medium: 'hsla(250, 59%, 42%, 1)',
    mediumLight: 'hsla(207, 0%, 15%, 1)',
    light: 'hsla(207, 0%, 10%, 1)',
    lighter: 'hsla(207, 0%, 0%, 1)',
    colorSet: purpleGroup,
  },
  [EColorTheme.DARK_GREEN]: {
    ...sharedColors,
    negModifier: 'hsla(0, 40%, 55%, 1)',
    zeroModifier: 'hsla(180, 27%, 57%, 1)',
    darker: 'hsla(130, 72%, 90%, 1)',
    dark: 'hsla(130, 72%, 38%, 1)',
    mediumDark: 'hsla(130, 72%, 38%, 1)',
    medium: 'hsla(130, 72%, 38%, 1)',
    mediumLight: 'hsla(207, 0%, 15%, 1)',
    light: 'hsla(207, 0%, 10%, 1)',
    lighter: 'hsla(207, 0%, 0%, 1)',
    colorSet: greenGroup,
  },
  [EColorTheme.DARK_GREY]: {
    ...sharedColors,
    negModifier: 'hsla(0, 40%, 55%, 1)',
    posModifier: 'hsla(100, 30%, 40%, 1)',
    zeroModifier: 'hsla(200, 27%, 57%, 1)',
    darker: 'hsla(207, 20%, 90%, 1)',
    dark: 'hsla(207, 20%, 49%, 1)',
    mediumDark: 'hsla(207, 20%, 39%, 1)',
    medium: 'hsla(207, 20%, 39%, 1)',
    mediumLight: 'hsla(207, 0%, 15%, 1)',
    light: 'hsla(207, 0%, 10%, 1)',
    lighter: 'hsla(207, 0%, 0%, 1)',
    colorSet: blueGreyGroup,
  },
  [EColorTheme.DARK_RED]: {
    ...sharedColors,
    negModifier: 'hsla(0, 40%, 55%, 1)',
    posModifier: 'hsla(100, 30%, 40%, 1)',
    zeroModifier: 'hsla(200, 27%, 57%, 1)',
    darker: 'hsla(350, 80%, 90%, 1)',
    dark: 'hsla(350, 80%, 39%, 1)',
    mediumDark: 'hsla(350, 80%, 39%, 1)',
    medium: 'hsla(350, 80%, 39%, 1)',
    mediumLight: 'hsla(0, 0%, 15%, 1)',
    light: 'hsla(0, 0%, 10%, 1)',
    lighter: 'hsla(0, 0%, 0%, 1)',
    colorSet: redGroup,
  },
  [EColorTheme.DARK_BLUE]: {
    ...sharedColors,
    negModifier: 'hsla(0, 40%, 55%, 1)',
    posModifier: 'hsla(100, 30%, 40%, 1)',
    zeroModifier: 'hsla(200, 27%, 57%, 1)',
    darker: 'hsla(200, 66%, 80%, 1)',
    dark: 'hsla(200, 79%, 36%, 1)',
